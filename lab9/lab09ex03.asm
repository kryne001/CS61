...
sub_3600					.FILL					x3600
sub_3800					.FILL					x3800
first_output_message			.STRINGZ				"input a number to be pushed onto the stack (single digit only)\n"
check_if_worked		.STRINGZ				"\nthe number input was: "
stack_addr				.FILL					x5300
top						.FILL					x5300
capacity					.FILL					#3
num_of_runs				.FILL					#2
popping_message		.STRINGZ				"\nPopping off value from stack\n"
multi_message			.STRINGZ				"\nTime to multiply\n"
;----------------------
;input sub
;----------------------
.orig x3200
...
underflow_message			.STRINGZ				"UNDERFLOW: cannot pop an empty stack"
...
LD R5, mem_array_final

LD R0, ten_3800
OUT
LD R6, pop_subroutine
JSRR R6
LD R6, converter_3800
STR R0, R5, #0
ADD R0, R0, R6
OUT
LEA R0, multiply_3800
PUTS
ADD R5, R5, #1
LD R6, pop_subroutine
JSRR R6
...
mem_array_final			.FILL					x5500
pop_subroutine				.FILL					x3600
multiplication_sub		.FILL					x4200
push_sub						.FILL					x3400
ten_3800						.FILL					#10
multiply_3800				.STRINGZ				" * "
equals_3800					.STRINGZ 			" = "
converter_3800				.FILL					#48
output_sub					.FILL					x4700
;--------------------------
